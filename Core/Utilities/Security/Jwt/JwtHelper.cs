...
namespace Core.Utilities.Security.Jwt
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims)
        {
            ...
            var token = jwtSecurityTokenHanler.WriteToken(jwt);// Bu işlem ile stringe çevirdim  tokenı
            ...
            User user, SigningCredentials signingCredentials, List<OperationClaim> operationClaims)
        {
            var jwt = new JwtSecurityToken(
                ...
                expires:_accessTokenExpiration/*tokenOptions.AccessTokenExpiration*/,
        ...
        public IEnumerable<Claim> SetClaims(User user , List<OperationClaim> operationClaims)
        {
            ...
            /*(Magicstring)claims.Add(new Claim("email" , user.Email)); Bu tarz işlemler yapabilirim ama onun yerine claimler extend edicem*/
